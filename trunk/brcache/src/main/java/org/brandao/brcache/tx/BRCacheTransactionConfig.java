...
public class BRCacheTransactionConfig extends BRCacheConfig{
	...
	public void setConfiguration(Configuration config){
        ...
        this.indexBufferSize     = config.getLong("transaction_index_buffer_size",		"8k");
        ...
        this.dataBufferSize      = config.getLong("transaction_data_buffer_size",		"1m");
        this.dataBlockSize       = config.getLong("transaction_data_block_size",		"64b");
        this.dataPageSize        = config.getLong("transaction_data_page_size",			"1k");
